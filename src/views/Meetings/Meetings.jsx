...
import { createMeeting, getAllMeetings, updateMeeting } from '../../services/api/meetings/meetings'
...
function Meetings() {
  ...
  const [notificationMsg, setNotificationMsg] = useState({
    ...
    message: "New meeting successfully created!!",
  });
  ...
  const handleTaskEdit = async (e) => {
    ...
    const res = await updateMeeting(form)
    if (res == true) {
      setClosing(!closing)
      setForm({
        id: "",
      ...
      <div className="grid grid-cols-12 gap-5 mt-5">
        ...
        <div className="col-span-12 xl:col-span-12 2xl:col-span-12">
          <div className="box p-5">
            <Calendar event={event} type="meeting" handleSubmit={handleTaskSubmit} handleEdit={handleTaskEdit} setForm={setForm} form={form} closing={closing} loading={loading} />
          </div>
        </div>
