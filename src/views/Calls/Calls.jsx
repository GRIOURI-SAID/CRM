...
import { createCall, getAllCalls, updateCall } from '../../services/api/calls/calls'
...
function Calls() {
  ...
  const [notificationMsg, setNotificationMsg] = useState({
    ...
    message: "New call successfully created!!",
  });
  ...
  const handleTaskEdit = async (e) => {
    ...
    const res = await updateCall(form)
    if (res == true) {
      setClosing(!closing)
      setForm({
        id: "",
      ...
      <div className="grid grid-cols-12 gap-5 mt-5">
        ...
        <div className="col-span-12 xl:col-span-12 2xl:col-span-12">
          <div className="box p-5">
            <Calendar event={event} type="call" handleSubmit={handleTaskSubmit} handleEdit={handleTaskEdit} setForm={setForm} form={form} closing={closing} loading={loading} />
          </div>
        </div>
