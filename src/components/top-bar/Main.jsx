...
import { getInfosUser } from "../../services/api/users/users";
            ...
            <DropdownContent className="bg-primary text-white">
              {mainInfos && (
                <DropdownHeader tag="div" className="!font-normal">
                  <>
                    <div className="font-medium">{`${mainInfos.first_name} ${mainInfos.last_name}`}</div>
              ...
              <div div onClick={() => navigate("/alpha/personnal/profile-view")}>
                <DropdownItem className="hover:bg-white/5">
                  <Lucide icon="User" className="w-4 h-4 mr-2 cursor-pointer" />
                  <div>Profile</div>
                </DropdownItem>
              </div>
              {/* <DropdownItem className="hover:bg-white/5">
              ...
              <DropdownItem className="hover:bg-white/5">
                <Lucide icon="Lock" className="w-4 h-4 mr-2 cursor-pointer" />
                <div onClick={() => navigate("/alpha/personnal/reset-password")}>Reset Password</div>
              </DropdownItem>
              {/* <DropdownItem className="hover:bg-white/5">
